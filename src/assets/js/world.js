...
!(function (t, e) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(e)
    : ((t =
        'undefined' != typeof globalThis ? globalThis : t || self).jsVectorMap = e());
})(this, function () {
  'use strict';
  ...
  var d = function (t, e, i) {
    ...
    f = {
      ...
      createElement: function (t, e, i, s) {
        ...
        return (
          i && (a[s ? 'innerHTML' : 'textContent'] = i), e && (a.className = e), a
        );
      },
    ...
    w = (function (t) {
      ...
      return (
        ...
        (i.createGroup = function (t) {
          var e = new v('g');
          return (
            this.node.appendChild(e.node), t && (e.node.id = t), (e.canvas = this), e
          );
        }),
        (i.add = function (t, e) {
  ...
  var T = Object.freeze({
      ...
      createMarkers: function (t, e) {
        ...
        t)) {
          if (
            ((i = t[o]), (a = this.getMarkerPosition(i)), (r = i.coords.join(':')), e)
          ) {
            if (
        ...
        t > this.params.zoomMax * this.baseScale
          ...
          void 0 !== e &&
            ...
            s
              ? ((d =
                  e +
                  (this.defaultWidth * (this.width / (this.defaultWidth * t))) / 2),
                (f =
                  i +
                  (this.defaultHeight * (this.height / (this.defaultHeight * t))) /
                    2))
    ...
    z = (function () {
      ...
      return (
        ...
        (e.emit = function (t, e) {
          for (var i in A)
            A[i] === t && f.isFunc(this.params[i]) && this.params[i].apply(this, e);
        }),
